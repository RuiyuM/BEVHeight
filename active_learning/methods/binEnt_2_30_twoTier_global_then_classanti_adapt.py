...
# =============================================================
class BinEnt30_TwoTier_GlobalThenClassAntiAdaptiveSelector(BaseActiveSelector):
    def __init__(
        self,
        # ------- Stage-A 参数 -------
...
try:
    ...
    _METHOD_REGISTRY["binEnt30_twoTier_global_then_classanti_adapt"] = BinEnt30_TwoTier_GlobalThenClassAntiAdaptiveSelector
except Exception:
    pass
