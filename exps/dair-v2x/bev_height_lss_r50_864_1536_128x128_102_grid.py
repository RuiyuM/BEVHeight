...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='/data/rxm210041/outputs/bev_height_lss_r50_864_1536_128x128_grid/checkpoints', filename='{epoch}', every_n_epochs=5, save_last=True, save_top_k=-1)
    ...
    if args.evaluate:
        ...
        backup_codebase(
            os.path.join('/data/rxm210041/outputs/bev_height_lss_r50_864_1536_128x128_grid', 'backup'))
        trainer.fit(model)
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='/data/rxm210041/outputs/bev_height_lss_r50_864_1536_128x128_grid')
